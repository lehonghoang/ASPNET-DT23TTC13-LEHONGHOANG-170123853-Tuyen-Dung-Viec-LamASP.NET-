        ...
        public MockDataService()
        {
            ...
            _jobs = new List<Job>
            {
                new Job
                {
                    ...
                    PostedDate = DateTime.Parse("2025-12-23"),
                    EmployerId = "1",
                    IsActive = true
                },
                new Job
                {
                    ...
                    PostedDate = DateTime.Parse("2025-12-22"),
                    EmployerId = "1",
                    IsActive = true
                },
                new Job
                {
                    ...
                    PostedDate = DateTime.Parse("2025-12-21"),
                    EmployerId = "1",
                    IsActive = true
                },
                new Job
            ...
            _applications = new List<Application>
            {
                new Application
                {
                    ...
                    JobId = "1",
                    CandidateId = "1",
                    AppliedDate = DateTime.Parse("2025-12-22"),
